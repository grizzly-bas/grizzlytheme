...
// function divi_theme_setup() {
//     if ( ! class_exists('ET_Builder_Module') ) {
//         return;

//     }

//     get_template_part( 'divi/modules/grizzly-text' );
//     $divi_text = new Grizzly_Module_Text();
//     // print_r('<pre>');
//     // print_r($divi_text);
//     // print_r('</pre>');
//     remove_shortcode( 'et_pb_text' );
//     add_shortcode( 'et_pb_text', array($divi_text, '_shortcode_callback') );
    
// }

// add_action( 'wp', 'divi_theme_setup', 9999 );

add_action('admin_head', 'remove_from_local_storage');
function remove_from_local_storage() { 
	echo "<script>localStorage.removeItem('et_pb_templates_gm_text');</script>";
}
...
function evr_initialize_divi_modules() {
    ...
    include_once get_template_directory() . '/divi/modules/grizzly-text.php';
