<?php
class Custom_ET_Builder_Module_Text extends ET_Builder_Module{
	function init() {
		$this->name       = esc_html__( 'adadad', 'et_builder' );
		$this->plural     = esc_html__( 'adadads', 'et_builder' );
		...
		$this->settings_modal_toggles = array(
			'general'  => array(
				'toggles' => array(
					'main_content' => esc_html__( 'adadad', 'et_builder' ),
				),
			),
			'advanced' => array(
				'toggles' => array(
					'text' => array(
						'title'    => esc_html__( 'adadad', 'et_builder' ),
						'priority' => 45,
...
new Custom_ET_Builder_Module_Text;